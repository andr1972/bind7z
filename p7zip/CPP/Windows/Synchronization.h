...
#ifdef _WIN32
#define OBJECTHANDLE _object
#else
#define OBJECTHANDLE _object.handle
#endif
...
public:
...
#ifdef _WIN32
  operator HANDLE() { return OBJECTHANDLE; }
#endif
  ...
  {
	  OBJECTHANDLE = ::CreateEvent(securityAttributes, BoolToBOOL(manualReset),
  ...
  {
	  OBJECTHANDLE = ::OpenEvent(desiredAccess, BoolToBOOL(inheritHandle), name);
    if (OBJECTHANDLE != 0)
      return 0;
    return ::GetLastError();
  }
